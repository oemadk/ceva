...
@Component({
  selector: 'app-table-normall',
  templateUrl: './table-normall.component.html',
  styleUrls: ['./table-normall.component.css']
})
export class TableNormallComponent implements OnInit {
...
data = [
  ...
  this.uploadService.s2(1).subscribe(
         (res)=>{
             console.log(res)
             this.data = res['data'];
    }  );
