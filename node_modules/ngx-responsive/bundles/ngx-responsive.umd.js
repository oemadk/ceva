(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-responsive', ['exports', '@angular/core', '@angular/common', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global['ngx-responsive'] = {}, global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var ResponsiveState = /** @class */ (function () {
        function ResponsiveState(_responsiveConfig, _platformId) {
            ...
            this._forceRefresh$ = new rxjs.BehaviorSubject(null);
            this._isBrowser = common.isPlatformBrowser(this._platformId);
            ...
            if (this._isBrowser) {
                var _resize$ = rxjs.combineLatest(rxjs.fromEvent(this._window, 'resize').pipe(operators.debounceTime(this._responsiveConfig.config.debounceTime), operators.defaultIfEmpty(), operators.startWith(this.getWidth('window'))), this._forceRefresh$).pipe(operators.debounceTime(this._responsiveConfig.config.debounceTime));
                var _pixelRatio$ = rxjs.fromEvent(this._window, 'onload')
                    .pipe(operators.defaultIfEmpty(), operators.startWith(this.getDevicePixelRatio()));
                var _device$ = rxjs.fromEvent(this._window, 'onload')
                    .pipe(operators.defaultIfEmpty(), operators.startWith(this.getUserAgent()));
                var _userAgent$ = rxjs.fromEvent(this._window, 'onload')
                    .pipe(operators.defaultIfEmpty(), operators.startWith(this.userAgentData()));
                var _orientation$ = rxjs.fromEvent(this._window, 'orientationchange')
                    .pipe(operators.defaultIfEmpty(), operators.startWith(this.getOrientation()));
                this.elemento$ = _resize$.pipe(operators.map(this.sizeOperations.bind(this)));
                this.ancho$ = _resize$.pipe(operators.map(this.sizeObserver.bind(this)));
                this.browser$ = _device$.pipe(operators.map(this.browserName.bind(this)));
                this.pixel$ = _pixelRatio$.pipe(operators.map(this.pixelRatio.bind(this)));
                this.device$ = _device$.pipe(operators.map(this.deviceDetection.bind(this)));
                this.orientation$ = _orientation$.pipe(operators.map(this.orientationDevice.bind(this)));
                this.standard$ = _device$.pipe(operators.map(this.standardDevices.bind(this)));
                this.ieVersion$ = _device$.pipe(operators.map(this.ieVersionDetect.bind(this)));
                this.userAgent$ = _userAgent$.pipe(operators.map(this.userAgentData.bind(this)));
            }
        }
        ...
        */
        ...
        ResponsiveState = __decorate([
            ...
            __metadata("design:paramtypes", [ResponsiveConfig, Object])
        ], ResponsiveState);
    ...
    var RESPONSIVE_BASE = /** @class */ (function () {
        function RESPONSIVE_BASE(templateRef, viewContainer, _responsiveState, cd, _platformId) {
            ...
            this._isBrowser = null;
            this.eventChanges = new core.EventEmitter();
            this._isBrowser = common.isPlatformBrowser(this._platformId);
        }
    ...
    var BrowserInfo = /** @class */ (function () {
        function BrowserInfo(_responsiveState, _platformId) {
            ...
            this._platformId = _platformId;
            this._isBrowser = null;
            this.replaySubject$ = new rxjs.ReplaySubject();
            this._isBrowser = common.isPlatformBrowser(this._platformId);
        }
        BrowserInfo.prototype.connect = function () {
            var _this = this;
            if (this._isBrowser) {
                this._subscription = this._responsiveState.browser$.pipe(operators.distinctUntilChanged())
        ...
        BrowserInfo = __decorate([
            __param(1, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState, Object])
        ], BrowserInfo);
        return BrowserInfo;
    }());
    ...
    var BrowserInfoRx = /** @class */ (function (_super) {
        ...
        function BrowserInfoRx(_responsiveState, _platformId) {
    ...
    var BrowserInfoDirective = /** @class */ (function (_super) {
        ...
        function BrowserInfoDirective(_responsiveState, viewContainer, cd, _platformId) {
            ...
            _this.cd = cd;
            _this._platformId = _platformId;
            _this.browser = new core.EventEmitter();
            return _this;
        }
    ...
    var IeInfo = /** @class */ (function () {
        ...
        IeInfo.prototype.connect = function () {
            var _this = this;
            if (this._isBrowser) {
                this._subscription = this._responsiveState.ieVersion$.pipe(operators.distinctUntilChanged())
                    .subscribe(function (data) {
                    _this._updateData(data);
                });
            }
    ...
    var IeInfoRx = /** @class */ (function (_super) {
        ...
        function IeInfoRx(_responsiveState, _platformId) {
            var _this = _super.call(this, _responsiveState, _platformId) || this;
            _this._responsiveState = _responsiveState;
            _this._platformId = _platformId;
            return _this;
    ...
    var IeInfoDirective = /** @class */ (function (_super) {
        ...
        function IeInfoDirective(_responsiveState, viewContainer, cd, _platformId) {
            ...
            _this.cd = cd;
            _this._platformId = _platformId;
            _this.ieVersion = new core.EventEmitter();
            return _this;
        }
        ...
        IeInfoDirective = __decorate([
            core.Directive({ selector: 'ie-info' }),
            __param(3, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState,
                core.ViewContainerRef,
                core.ChangeDetectorRef, Object])
    ...
    var DevicesInfo = /** @class */ (function () {
        ...
        DevicesInfo.prototype.connect = function () {
            var _this = this;
            if (this._isBrowser) {
                this._subscription = this._responsiveState.device$.pipe(operators.distinctUntilChanged())
                    .subscribe(function (data) {
                    _this._updateData(data);
                });
            }
    ...
    var DeviceInfoDirective = /** @class */ (function (_super) {
        ...
        function DeviceInfoDirective(_responsiveState, viewContainer, cd, _platformId) {
            ...
            _this.cd = cd;
            _this._platformId = _platformId;
            _this.device = new core.EventEmitter();
            return _this;
        }
        ...
        DeviceInfoDirective = __decorate([
            core.Directive({ selector: 'device-info' }),
            __param(3, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState,
                core.ViewContainerRef,
                core.ChangeDetectorRef, Object])
    ...
    var DeviceStandardInfo = /** @class */ (function () {
        function DeviceStandardInfo(_responsiveState, _platformId) {
            this._responsiveState = _responsiveState;
            this._platformId = _platformId;
            this._isBrowser = null;
            this.replaySubject$ = new rxjs.ReplaySubject();
        ...
        DeviceStandardInfo.prototype.connect = function () {
            var _this = this;
            if (this._isBrowser) {
                this._subscription = this._responsiveState.standard$.pipe(operators.distinctUntilChanged())
                    .subscribe(function (data) {
                    _this._updateData(data);
                });
            }
    ...
    var DeviceStandardInfoDirective = /** @class */ (function (_super) {
        ...
        function DeviceStandardInfoDirective(_responsiveState, viewContainer, cd, _platformId) {
            var _this = _super.call(this, _responsiveState, _platformId) || this;
            _this._responsiveState = _responsiveState;
            _this.viewContainer = viewContainer;
            _this.cd = cd;
            _this._platformId = _platformId;
            _this.standard = new core.EventEmitter();
            return _this;
        }
        ...
        DeviceStandardInfoDirective = __decorate([
            core.Directive({ selector: 'device-standard-info' }),
            __param(3, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState,
                core.ViewContainerRef,
                core.ChangeDetectorRef, Object])
    ...
    var OrientationInfo = /** @class */ (function () {
        function OrientationInfo(_responsiveState, _platformId) {
            this._responsiveState = _responsiveState;
            this._platformId = _platformId;
            this._isBrowser = null;
            this.replaySubject$ = new rxjs.ReplaySubject();
        ...
        OrientationInfo.prototype.connect = function () {
            var _this = this;
            if (this._isBrowser) {
                this._subscription = this._responsiveState.orientation$.pipe(operators.distinctUntilChanged())
                    .subscribe(function (data) {
                    _this._updateData(data);
                });
            }
    ...
    var OrientationInfoDirective = /** @class */ (function (_super) {
        ...
        function OrientationInfoDirective(_responsiveState, viewContainer, cd, _platformId) {
            ...
            _this.cd = cd;
            _this._platformId = _platformId;
            _this.orientation = new core.EventEmitter();
            return _this;
        }
        ...
        OrientationInfoDirective = __decorate([
            core.Directive({ selector: 'orientation-info' }),
            __param(3, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState,
                core.ViewContainerRef,
                core.ChangeDetectorRef, Object])
    ...
    var DeviceInfoRx = /** @class */ (function (_super) {
        ...
        function DeviceInfoRx(_responsiveState, _platformId) {
            var _this = _super.call(this, _responsiveState, _platformId) || this;
            _this._responsiveState = _responsiveState;
            _this._platformId = _platformId;
            return _this;
        }
        DeviceInfoRx = __decorate([
            core.Injectable(),
            __param(1, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState, Object])
        ], DeviceInfoRx);
    ...
    var DeviceStandardInfoRx = /** @class */ (function (_super) {
        ...
        function DeviceStandardInfoRx(_responsiveState, _platformId) {
            var _this = _super.call(this, _responsiveState, _platformId) || this;
            _this._responsiveState = _responsiveState;
            _this._platformId = _platformId;
            return _this;
        }
        DeviceStandardInfoRx = __decorate([
            core.Injectable(),
            __param(1, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState, Object])
    ...
    var PixelRatioInfoDirective = /** @class */ (function () {
        function PixelRatioInfoDirective(_responsiveState, viewContainer, cd, _platformId) {
            ...
            this._platformId = _platformId;
            this._isBrowser = null;
            this.pixelratio = new core.EventEmitter();
            this._isBrowser = common.isPlatformBrowser(this._platformId);
        }
        ...
        PixelRatioInfoDirective = __decorate([
            core.Directive({ selector: 'pixel-ratio-info' }),
            __param(3, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState,
                core.ViewContainerRef,
                core.ChangeDetectorRef, Object])
    ...
    var ResponsiveDirective = /** @class */ (function () {
        ...
        __decorate([
            core.Input(),
            __metadata("design:type", ResponsiveWindowDirective),
            __metadata("design:paramtypes", [ResponsiveWindowDirective])
    ...
    var ResponsiveSizeInfo = /** @class */ (function () {
        ...
        ResponsiveSizeInfo.prototype.connect = function () {
            var _this = this;
            if (this._isBrowser) {
                this._subscription = this._responsiveState.elemento$.pipe(operators.distinctUntilChanged())
                    .subscribe(function (data) {
                    _this._updateData(data);
                });
            }
    ...
    var ResponsiveSizeInfoDirective = /** @class */ (function (_super) {
        ...
        function ResponsiveSizeInfoDirective(_responsiveState, viewContainer, cd, _platformId) {
            ...
            _this.cd = cd;
            _this._platformId = _platformId;
            _this.statechanges = new core.EventEmitter();
            return _this;
        }
        ...
        ResponsiveSizeInfoDirective = __decorate([
            core.Directive({ selector: 'responsiveSizeInfo' }),
            __param(3, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState,
                core.ViewContainerRef,
                core.ChangeDetectorRef, Object])
    ...
    var ResponsiveSizeInfoRx = /** @class */ (function (_super) {
        ...
        function ResponsiveSizeInfoRx(_responsiveState, _platformId) {
            var _this = _super.call(this, _responsiveState, _platformId) || this;
            _this._responsiveState = _responsiveState;
            _this._platformId = _platformId;
            return _this;
        }
        ResponsiveSizeInfoRx = __decorate([
            core.Injectable(),
            __param(1, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState, Object])
    ...
    var UserAgentInfo = /** @class */ (function () {
        ...
        UserAgentInfo.prototype.connect = function () {
            var _this = this;
            if (this._isBrowser) {
                this._subscription = this._responsiveState.userAgent$.pipe(operators.distinctUntilChanged())
                    .subscribe(function (data) {
    ...
    var UserAgentInfoDirective = /** @class */ (function (_super) {
        ...
        function UserAgentInfoDirective(_responsiveState, cd, _platformId) {
            ...
            _this.cd = cd;
            _this._platformId = _platformId;
            _this.info = new core.EventEmitter();
            return _this;
        }
    ...
    var UserAgentInfoRx = /** @class */ (function (_super) {
        ...
        function UserAgentInfoRx(_responsiveState, _platformId) {
            var _this = _super.call(this, _responsiveState, _platformId) || this;
            _this._responsiveState = _responsiveState;
            _this._platformId = _platformId;
            return _this;
        }
        UserAgentInfoRx = __decorate([
            core.Injectable(),
            __param(1, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [ResponsiveState, Object])
        ], UserAgentInfoRx);
     ...
     * @license MIT
     */
    var RESPONSIVE_CONFIGURATION = new core.InjectionToken('config');
    ...
    exports.BOOTSTRAP_DIRECTIVES = BOOTSTRAP_DIRECTIVES;
    exports.BOTS = BOTS;
    exports.BROWSER_DIRECTIVES = BROWSER_DIRECTIVES;
    exports.BROWSER_INFO_RX = BROWSER_INFO_RX;
    exports.BROWSER_NAMES = BROWSER_NAMES;
    exports.BrowserInfoDirective = BrowserInfoDirective;
    exports.BrowserInfoRx = BrowserInfoRx;
    exports.CUSTOMSIZES_DIRECTIVES = CUSTOMSIZES_DIRECTIVES;
    exports.DEFAULT_BREACKPOINTS = DEFAULT_BREACKPOINTS;
    exports.DEVICES_DIRECTIVES = DEVICES_DIRECTIVES;
    exports.DEVICES_INFO_RX = DEVICES_INFO_RX;
    exports.DeviceInfoDirective = DeviceInfoDirective;
    exports.DeviceInfoRx = DeviceInfoRx;
    exports.DeviceStandardInfoDirective = DeviceStandardInfoDirective;
    exports.DeviceStandardInfoRx = DeviceStandardInfoRx;
    exports.GAME_DEVICES = GAME_DEVICES;
    exports.HideIEVersionDirective = HideIEVersionDirective;
    exports.HideItBootstrapDirective = HideItBootstrapDirective;
    exports.HideItBrowserDirective = HideItBrowserDirective;
    exports.HideItDeviceDirective = HideItDeviceDirective;
    exports.HideItSizesDirective = HideItSizesDirective;
    exports.HideItStandardDirective = HideItStandardDirective;
    exports.IE_INFO_RX = IE_INFO_RX;
    exports.IE_VERSIONS = IE_VERSIONS;
    exports.IeInfoDirective = IeInfoDirective;
    exports.IeInfoRx = IeInfoRx;
    exports.Is1xPixelDirective = Is1xPixelDirective;
    exports.Is4kDirective = Is4kDirective;
    exports.IsAndroidMobileDirective = IsAndroidMobileDirective;
    exports.IsAndroidTabletDirective = IsAndroidTabletDirective;
    exports.IsChromeDirective = IsChromeDirective;
    exports.IsDesktopDirective = IsDesktopDirective;
    exports.IsFirefoxDirective = IsFirefoxDirective;
    exports.IsIE10Directive = IsIE10Directive;
    exports.IsIE11Directive = IsIE11Directive;
    exports.IsIE12Directive = IsIE12Directive;
    exports.IsIE9Directive = IsIE9Directive;
    exports.IsIEDirective = IsIEDirective;
    exports.IsIpadDirective = IsIpadDirective;
    exports.IsIphoneDirective = IsIphoneDirective;
    exports.IsLandscapeDirective = IsLandscapeDirective;
    exports.IsMobileDirective = IsMobileDirective;
    exports.IsOperaDirective = IsOperaDirective;
    exports.IsPortraitDirective = IsPortraitDirective;
    exports.IsRetinaDirective = IsRetinaDirective;
    exports.IsSafariDirective = IsSafariDirective;
    exports.IsSmartTvDirective = IsSmartTvDirective;
    exports.IsTabletDirective = IsTabletDirective;
    exports.IsWindowsPhoneDirective = IsWindowsPhoneDirective;
    exports.LINUX_OS = LINUX_OS;
    exports.LgDirective = LgDirective;
    exports.MOBILE = MOBILE;
    exports.MdDirective = MdDirective;
    exports.OS_SYSTEMS = OS_SYSTEMS;
    exports.OrientationInfoDirective = OrientationInfoDirective;
    exports.OrientationInfoRx = OrientationInfoRx;
    exports.PIXELRATIO_DIRECTIVES = PIXELRATIO_DIRECTIVES;
    exports.PixelRatioInfoDirective = PixelRatioInfoDirective;
    exports.REG_BOTS = REG_BOTS;
    exports.REG_BROWSERS = REG_BROWSERS;
    exports.REG_GAME_DEVICES = REG_GAME_DEVICES;
    exports.REG_IE_VERSIONS = REG_IE_VERSIONS;
    exports.REG_LINUX_OS = REG_LINUX_OS;
    exports.REG_MAC_OS_VERSION = REG_MAC_OS_VERSION;
    exports.REG_MOBILES = REG_MOBILES;
    exports.REG_OS = REG_OS;
    exports.REG_SMARTS_TV = REG_SMARTS_TV;
    exports.REG_SORT_NAMES = REG_SORT_NAMES;
    exports.REG_TABLETS = REG_TABLETS;
    exports.REG_WEARABLES = REG_WEARABLES;
    exports.REG_WINDOWS_OS_VERSION = REG_WINDOWS_OS_VERSION;
    exports.REG_WINDOWS_PHONE_OS_VERSION = REG_WINDOWS_PHONE_OS_VERSION;
    exports.RESPONSIVEWINDOW_DIRECTIVE = RESPONSIVEWINDOW_DIRECTIVE;
    exports.RESPONSIVE_BASE = RESPONSIVE_BASE;
    exports.RESPONSIVE_CONFIGURATION = RESPONSIVE_CONFIGURATION;
    exports.RESPONSIVE_DIRECTIVE = RESPONSIVE_DIRECTIVE;
    exports.RESPONSIVE_SIZE_INFO_DIRECTIVE = RESPONSIVE_SIZE_INFO_DIRECTIVE;
    exports.RESPONSIVE_SIZE_INFO_RX = RESPONSIVE_SIZE_INFO_RX;
    ...
    exports.ResponsiveSizeInfoDirective = ResponsiveSizeInfoDirective;
    exports.ResponsiveSizeInfoRx = ResponsiveSizeInfoRx;
    exports.ResponsiveState = ResponsiveState;
    exports.ResponsiveWindowDirective = ResponsiveWindowDirective;
    exports.SMART_TV = SMART_TV;
    exports.ShowIEVersionDirective = ShowIEVersionDirective;
    exports.ShowItBootstrapDirective = ShowItBootstrapDirective;
    exports.ShowItBrowserDirective = ShowItBrowserDirective;
    exports.ShowItDeviceDirective = ShowItDeviceDirective;
    exports.ShowItSizesDirective = ShowItSizesDirective;
    exports.ShowItStandardDirective = ShowItStandardDirective;
    exports.SmDirective = SmDirective;
    exports.TABLET = TABLET;
    exports.USERAGENT_INFO_DIRECTIVE = USERAGENT_INFO_DIRECTIVE;
    exports.USERAGENT_INFO_RX = USERAGENT_INFO_RX;
    exports.USER_AGENT = USER_AGENT;
    exports.UserAgentInfo = UserAgentInfo;
    exports.UserAgentInfoDirective = UserAgentInfoDirective;
    exports.UserAgentInfoRx = UserAgentInfoRx;
    exports.WINDOWS_OS = WINDOWS_OS;
    exports.XlDirective = XlDirective;
    exports.XsDirective = XsDirective;
    exports.responsiveConfiguration = responsiveConfiguration;
    exports.ɵa = BrowserInfo;
    exports.ɵb = IeInfo;
    exports.ɵc = DevicesInfo;
    exports.ɵd = DeviceStandardInfo;
    exports.ɵe = OrientationInfo;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ngx-responsive.umd.js.map
