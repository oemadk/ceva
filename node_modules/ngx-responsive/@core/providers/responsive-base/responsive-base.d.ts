...
export declare abstract class RESPONSIVE_BASE<T> implements OnInit, OnDestroy {
    ...
    private cd;
    protected readonly _platformId: any;
    private _noRepeat;
    ...
    private _isBrowser;
    constructor(templateRef: TemplateRef<any>, viewContainer: ViewContainerRef, _responsiveState: ResponsiveState, cd: ChangeDetectorRef, _platformId: any);
